...
subtitle: function(data) {
	...
	const info = ['Game Application ID', 'Game Details', 'Game Name', 'Game State', 'Game Is Being Streamed?', 'Game Stream URL', 'Game Status Type', 'Game Large Image ID', 'Game Large Image URL', 'Game Large Image Text', 'Game Small Image ID', 'Game Small Image URL', 'Game Small Image Text', 'Game Timestamps', 'Game Party'];
...
<div>
	<div style="padding-top: 8px; width: 70%;">
		...
		<select id="info" class="round">
			...
			<option value="13">Game Timestamps</option>
			<option value="14">Game Party</option>
	...
	switch(info) {
		...
		case 13:
		    if(!mem.presence.game) {
				...
				result = mem.presence.game.timestamps;
			}
			break;
		case 14:
		    if(!mem.presence.game) {
				...
				result = mem.presence.game.party;
			}
			break;
		default:
			break;
